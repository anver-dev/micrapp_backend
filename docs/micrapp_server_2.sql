...
--
-- Servidor: localhost
-- Tiempo de generación: 22-12-2021 a las 21:41:40
...
--
-- Base de datos: `micrapp_server_2`
--
...
CREATE TABLE `rol` (
  ...
  `rol` enum('Secundario','Primario','Visitante') NOT NULL,
...
ALTER TABLE `rol`
  ...
  ADD KEY `rol_nivelacceso_fk` (`id_nivel_acceso`);
...
--
ALTER TABLE `rol`
  ADD CONSTRAINT `rol_nivelacceso_fk` FOREIGN KEY (`id_nivel_acceso`) REFERENCES `nivel_acceso` (`id_nivel_acceso`);
